    ...
    // 当前项取消选中
        ...
        if (global.pageNum === '5') {
            ...
            for (let i = 0; i < global.selectedItems__Num.length; i++) {
                ...
                if (global.selectedItems__Num[i].name.replace(/\/src\/assets\/image\/img\/font_selectedColor\//, '/src/assets/image/img/') === targetValue) {
                    console.log('删除数组里的对象：', global.selectedItems__Num[i]);
...
<div class="bigBox" 
    ...
    <div
        ...
        >
            ...
            >
            <!-- 中间文字 -->
            <span v-if="showCenterText" class="middle-font">{{ index }}</span>
            <!-- 文字图标 -->
            <div class="font-item">
    ...
    <!-- 必选小盒子 -->
     ...
     >
            <!-- 必选状态图标 -->
            <img src="/assets/image/img/必选.png" alt="图片失效" class="icon-img"
            :style="{
                width: iconMainWidth,
                height: iconMainHeight,
            }"
            ...
            <!-- 文字图标 -->
            <div class="font-item">
                <img src="/assets/image/img/人工咨询服务.png" alt="图片失效" class="font-img"
                :style="{
                    width: imgMainWidth,
                    height: imgMainHeight,
                }">
