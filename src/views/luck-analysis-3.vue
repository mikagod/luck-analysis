<script setup>
    ...
    // ********************引入图片********************
        ...
        import catButtonDefLeftImg from '/assets/image/img/流年运气Def.png'
        import catButtonDefRightImg from '/assets/image/img/近期运气Def.png'
        import catButtonHoverLeftImg from '/assets/image/img/流年运气Hover.png'
        import catButtonHoverRightImg from '/assets/image/img/近期运气Hover.png'

    // ********************/引入图片********************

    // ********************导入组件********************
    import Background from '@/components/container/bg.vue' // 背景 
    import Dropdown from '@/components/container/Dropdown.vue' // 下拉框
    // ********************/导入组件********************
    ...
    if (global.luckValue === '') {
        ...
        // 如果条件满足，允许跳转
        console.log(`pinia里的luckValue状态`,global.luckValue);
        router.push('/4'); // 使用路由器实例进行跳转
    }
    }
    // ********************/方法********************
    ...
    <Background>
            ...
            <div class="page page-direction">
                ...
                <template #header-title>
                    <img src="/assets/image/img/请选择：.png" alt="图片失效">
                </template>
                <div style="
                    display: flex; 
                ...
                <div class="page-container">
                    <div class="row-two-box">
                        ...
                        <span class="selected-font">
                            <img v-if="showSelectedLeft" class="font-img" src="/assets/image/img/Frame 36.png" alt="">
                        </span>
                    </div>
                    <div class="row-two-box">
                        ...
                        <span class="selected-font">
                            <img v-if="showSelectedRight" class="font-img" src="/assets/image/img/Frame 36.png" alt="">
                        </span>
                    </div>
                </div>
                </div>
